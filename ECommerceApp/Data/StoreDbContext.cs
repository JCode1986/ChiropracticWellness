        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Inventory>().HasData(
                ...
                new Inventory
                {
                    ...
                    Price = 250.00M,
                    Duration = "1 hour",
                    Image = "~/Assets/InitialEvaluation.jpg"
                },
                new Inventory
                {
                    ID = 2,
                    ...
                    Image = "~/Assets/FollowUpConsultation.jpg"
                },
                new Inventory
                {
                    ID = 3,
                ...
                new Inventory
                {
                    ...
                    Price = 85.00M,
                    Duration = "45 minutes",
                    Image = "~/Assets/NeckAdjustment1.jpg"
                },
                new Inventory
                {
                    ID = 5,
                ...
                new Inventory
                {
                    ...
                    Image = "~/Assets/NeckAdjustment2.jpg"
                },
                new Inventory
                {
                    ID = 8,
